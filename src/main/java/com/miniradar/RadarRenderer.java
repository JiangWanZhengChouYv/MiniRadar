...
public class RadarRenderer
{
    ...
    public void render(PoseStack poseStack, float partialTick)
    {
        try {
            ...
            drawRadarBackground(poseStack);
            drawPlayerMarker(poseStack);
            drawEntities(poseStack, partialTick);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    {
        net.minecraft.client.gui.net.minecraft.client.gui.net.minecraft.client.gui.net.minecraft.client.gui.GuiGraphics.fill(poseStack, RADAR_OFFSET, RADAR_OFFSET, RADAR_OFFSET + RADAR_SIZE, RADAR_OFFSET + RADAR_SIZE, 0x99000000);
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, RADAR_OFFSET, RADAR_OFFSET, RADAR_OFFSET + RADAR_SIZE, RADAR_OFFSET+1, 0xFFFFFFFF);
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, RADAR_OFFSET, RADAR_OFFSET, RADAR_OFFSET+1, RADAR_OFFSET + RADAR_SIZE, 0xFFFFFFFF);
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, RADAR_OFFSET + RADAR_SIZE-1, RADAR_OFFSET, RADAR_OFFSET + RADAR_SIZE, RADAR_OFFSET + RADAR_SIZE, 0xFFFFFFFF);
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, RADAR_OFFSET, RADAR_OFFSET + RADAR_SIZE-1, RADAR_OFFSET + RADAR_SIZE, RADAR_OFFSET + RADAR_SIZE, 0xFFFFFFFF);
    }
    ...
    private void drawPlayerMarker(PoseStack poseStack)
    {
        ...
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, centerX - size - 1, centerY - size - 1, centerX + size + 1, centerY + size + 1, 0xFF000000);
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, centerX - size, centerY - size, centerX + size, centerY + size, 0xFFFFFFFF);
    }
    ...
    private void drawEntities(PoseStack poseStack, float partialTick)
    {
        ...
        for (Entity entity : entities) {
            ...
            if (radarX >= 0 && radarX < RADAR_SIZE && radarZ >= 0 && radarZ < RADAR_SIZE) {
                drawEntityMarker(poseStack, (int) radarX, (int) radarZ, entity);
            }
        }
    }

    private void drawEntityMarker(PoseStack poseStack, int x, int y, Entity entity)
    {
        ...
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, screenX - size - 1, screenY - size - 1, screenX + size + 1, screenY + size + 1, 0xFF000000);
        net.minecraft.client.gui.GuiGraphics.fill(poseStack, screenX - size, screenY - size, screenX + size, screenY + size, color);
    }
